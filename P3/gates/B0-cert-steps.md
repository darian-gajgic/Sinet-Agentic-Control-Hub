...
- **Step 13 done (2026-07-20, coordinator, next morning):** crt.sh shows exactly **one certificate** for the FQDN — serial `0591e4f2be805a1b5bc6153016b2a5124f70`, Let's Encrypt (CN=YE2), CN/SAN `sinet.tailfd0b1e.ts.net` and nothing else, notBefore **2026-07-19 21:27:21 UTC** (matching the pre-issuance finding above to the second), notAfter 2026-10-17; two CT log entries (precert + leaf, both logged 2026-07-19 22:25 UTC, ids 28075562579/28075565469). Register rows 1 and 3 now confirmed in the world exactly as signed under operator item 7 — the bland hostname publishes existence and nothing more. **Runbook fully CLOSED.**
