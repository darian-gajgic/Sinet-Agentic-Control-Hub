...
4. **Exit:** full battery + bundle measurement + an operator click-through of the restyled app (same one-command script) → then the D6 upgrade ceremony → bring-up.
