...
func TestMigrationContiguousUserVersion(t *testing.T) {
	...
	// (the S10.3 price table's durable home) and 0022 is P3-RW-3's (the
	// pre-approval project-attribution view re-create). A floor would let an
	// unnoticed migration slip in.
	if v != 22 {
