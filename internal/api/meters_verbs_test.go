...
func TestPartBCountersArePinned(t *testing.T) {
	...
	// stay byte-untouched.
	if v != 24 {
		t.Errorf("user_version = %d, want 24 (0001–0017 untouched; 0017 is part B's, 0018 part C's, 0019 B6-3A's, 0020 B6-7's, 0021 B6-9's, 0022 P3-RW-3's, 0023 P3-RW-7's, 0024 P3-RW-11's)", v)
	}
