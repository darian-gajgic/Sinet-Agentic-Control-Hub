...
func b2Seeds() ([]b2Seed, error) {
	...
	software, ok := taxonomies[intake.FamilySoftware]
	if !ok {
		return nil, fmt.Errorf("memory: software taxonomy seed missing")
	}
	...
	return []b2Seed{
		{
			...
			fileName: "intake-taxonomy-software.json", object: software,
		},
		{
