...
func TestMigrationContiguousUserVersion(t *testing.T) {
	...
	// (the capture's task family), 0025 is P3-LN-6's (the S10.4 plan-unit
	// automation budget, per (person, lane, window)) and 0026 is P3-GF10's (the
	// revision's producing-run attribution join key).
